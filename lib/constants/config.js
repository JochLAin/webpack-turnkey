...
let config = {
    rules: [
        ...
        { test: /\.jsx?$/, use: { loader: 'babel-loader', options: { presets: ['env', 'es2015', 'stage-0', 'stage-1', 'stage-2', 'stage-3', 'react'] }}},
...
if (exists(path.resolve('webpack.config.js'))) {
    module.exports = Object.assign({}, config, require(path.resolve('webpack.config.js')));
} else {
